...
// Copyright (c) 2017 The Uwallet developers
...
uint256 hashGenesisBlock("0x00000b06e253dabad067499f45d8cba6ac78bd8c7a7cda5aebc305164ade4180");
static const unsigned int timeGenesisBlock = 1512806400;
...
const string strMessageMagic = "Uwallet Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "December 9, 2017. The U-wallet release. ";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043541c7340664b518ea1087b9a46117c6c3ef786e56dc88441db05187fea9c26ec6beaf685b38c1f6ed9c375bc3ec386dd095a83a822ca8eeea1ceaf101c96a5c") << OP_CHECKSIG;
        CBlock block;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x3b54a63c1f03408b09f26fe6fc8d124c6fce6a5d2093793f46ca295f20a28ab9"));
...
unsigned char pchMessageStart[4] = { 0xf0, 0xad, 0xef, 0xdb };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UwalletMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UwalletMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("UwalletMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("Uwallet-miner");
    ...
    try { loop {
        ...
        printf("Running UwalletMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("UwalletMiner terminated\n");
        throw;
    }
}
