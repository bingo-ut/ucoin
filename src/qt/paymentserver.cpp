...
const QString BITCOIN_IPC_PREFIX("Uwallet:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click Uwallet: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start Uwallet: click-to-pay handler");
    else
...
{
    // clicking on Uwallet: URLs creates FileOpen events on the Mac:
